...
(ert-deftest nelisp-sys-eval-kernel-cons-setq-runs ()
  "Doc 133 eval-kernel step 7: add `setq' — mutate an existing env binding.
Builds on `nelisp-sys-eval-kernel-cons-lambda-runs'.  Adds nl_env_set,
which walks the env alist like nl_env_get but POKES the matched pair's
value slot (pair+40)=val instead of returning it.  A setq dispatch
\(op `s' (115) / len 4) is added in the SYMBOL-operator path before the
arithmetic fall-through: sym = cadr, valform = caddr; eval valform;
nl_env_set the new value; return the value.  Evaluates
`(let ((x 0)) (progn (setq x 42) x))': bind x->0, progn evaluates
`(setq x 42)' [mutates x to 42] then `x' [reads 42] -> exit 42.
Native-verified; no Rust runtime."
  (unless (and (eq system-type 'gnu/linux)
               (string-prefix-p "x86_64" system-configuration))
    (ert-skip "requires x86_64 Linux"))
  (require 'nelisp-sys-adapter-nelisp)
  (unless (nelisp-sys-adapter-available-p)
    (ert-skip "NeLisp toolchain not available"))
  (let ((path (make-temp-file "nelisp-sys-eval-cons-setq")))
    (unwind-protect
        (progn
          (delete-file path)
          (nelisp-sys-compile-executable
           '((sys:defun nl_symname_byte ((slot usize)) i64 (:alloc none)
             ...
             (sys:defun main () i64 (:syscall may :alloc none)
               (let ((r usize (sys:syscall 9 0 4096 3 34 -1 0)))
                 (sys:poke-u64 (+ r 0) 7)     (sys:poke-u64 (+ r 8) (+ r 128))
                 (sys:poke-u64 (+ r 128) 4)   (sys:poke-u64 (+ r 136) (+ r 1664))
                 (sys:poke-u64 (+ r 160) 7)   (sys:poke-u64 (+ r 168) (+ r 256))
                 (sys:poke-u64 (+ r 256) 7)   (sys:poke-u64 (+ r 264) (+ r 512))
                 (sys:poke-u64 (+ r 288) 7)   (sys:poke-u64 (+ r 296) (+ r 384))
                 (sys:poke-u64 (+ r 384) 7)   (sys:poke-u64 (+ r 392) (+ r 640))
                 (sys:poke-u64 (+ r 416) 0)
                 (sys:poke-u64 (+ r 512) 7)   (sys:poke-u64 (+ r 520) (+ r 768))
                 (sys:poke-u64 (+ r 544) 0)
                 (sys:poke-u64 (+ r 768) 4)   (sys:poke-u64 (+ r 776) (+ r 1728))
                 (sys:poke-u64 (+ r 800) 7)   (sys:poke-u64 (+ r 808) (+ r 896))
                 (sys:poke-u64 (+ r 896) 2)   (sys:poke-u64 (+ r 904) 0)
                 (sys:poke-u64 (+ r 928) 0)
                 (sys:poke-u64 (+ r 640) 4)   (sys:poke-u64 (+ r 648) (+ r 1792))
                 (sys:poke-u64 (+ r 672) 7)   (sys:poke-u64 (+ r 680) (+ r 1024))
                 (sys:poke-u64 (+ r 1024) 7)  (sys:poke-u64 (+ r 1032) (+ r 1280))
                 (sys:poke-u64 (+ r 1056) 7)  (sys:poke-u64 (+ r 1064) (+ r 1152))
                 (sys:poke-u64 (+ r 1152) 4)  (sys:poke-u64 (+ r 1160) (+ r 1728))
                 (sys:poke-u64 (+ r 1184) 0)
                 (sys:poke-u64 (+ r 1280) 4)  (sys:poke-u64 (+ r 1288) (+ r 1856))
                 (sys:poke-u64 (+ r 1312) 7)  (sys:poke-u64 (+ r 1320) (+ r 1408))
                 (sys:poke-u64 (+ r 1408) 4)  (sys:poke-u64 (+ r 1416) (+ r 1728))
                 (sys:poke-u64 (+ r 1440) 7)  (sys:poke-u64 (+ r 1448) (+ r 1536))
                 (sys:poke-u64 (+ r 1536) 2)  (sys:poke-u64 (+ r 1544) 42)
                 (sys:poke-u64 (+ r 1568) 0)
                 (sys:poke-u64 (+ r 1664) 3)  (sys:poke-u64 (+ r 1672) (+ r 1696)) (sys:poke-u64 (+ r 1680) 3)
                 (sys:poke-u64 (+ r 1696) 108)
                 (sys:poke-u64 (+ r 1728) 1)  (sys:poke-u64 (+ r 1736) (+ r 1760)) (sys:poke-u64 (+ r 1744) 1)
                 (sys:poke-u64 (+ r 1760) 120)
                 (sys:poke-u64 (+ r 1792) 5)  (sys:poke-u64 (+ r 1800) (+ r 1824)) (sys:poke-u64 (+ r 1808) 5)
                 (sys:poke-u64 (+ r 1824) 112)
                 (sys:poke-u64 (+ r 1856) 4)  (sys:poke-u64 (+ r 1864) (+ r 1888)) (sys:poke-u64 (+ r 1872) 4)
                 (sys:poke-u64 (+ r 1888) 115)
                 (sys:poke-u64 (+ r 1920) 0)
                 (sys:poke-u64 (+ r 1952) (+ r 2560))
                 (nl_eval (+ r 0) (+ r 1920) (+ r 1952))))
             (sys:defun _start () void
               (:abi nelisp-internal :syscall may :alloc none)
               (sys:exit (main))))
           path)
...
(ert-deftest nelisp-sys-eval-kernel-cons-while-runs ()
  "Doc 133 eval-kernel step 8: add the `while' loop + the `<' operator.
Builds on `nelisp-sys-eval-kernel-cons-setq-runs'.  Adds nl_eval_while,
which evaluates the condition slot; while it is non-nil, it discards the
result of nl_eval_body on the body list then recurses, else returns 0.
A while dispatch (op `w' (119) / len 5) is added in the SYMBOL-operator
path before arithmetic: condslot = cadr, bodylist = cddr (b2+32).  `<'
\(opb 60) is added to the arithmetic dispatch as (if (< a1 a2) 1 0).  The
env ((x . 0)) is pre-built in memory.  Evaluates
`(progn (while (< x 42) (setq x (+ x 1))) x)': the loop increments x from
0 to 42 (stops when (< x 42) is false), then x reads 42 -> exit 42.
Native-verified; no Rust runtime."
  (unless (and (eq system-type 'gnu/linux)
               (string-prefix-p "x86_64" system-configuration))
    (ert-skip "requires x86_64 Linux"))
  ...
  (unless (nelisp-sys-adapter-available-p)
    (ert-skip "NeLisp toolchain not available"))
  (let ((path (make-temp-file "nelisp-sys-eval-cons-while")))
    (unwind-protect
        (progn
          (delete-file path)
          (nelisp-sys-compile-executable
                                     ...
                                     (let ((b3 usize (sys:cast usize (sys:peek-u64 (+ b2 40)))))
                                       (let ((a2 i64 (nl_eval b3 env acell)))
                                         (if (= opb 43) (+ a1 a2)
                                           (if (= opb 45) (- a1 a2)
                                             (if (= opb 42) (* a1 a2)
                                               (if (= opb 60) (if (< a1 a2) (sys:cast i64 1) (sys:cast i64 0))
                                                 (sys:cast i64 -1)))))))))))))))))
                  (else (sys:cast i64 -1)))))
             (sys:defun main () i64 (:syscall may :alloc none)
               (let ((r usize (sys:syscall 9 0 4096 3 34 -1 0)))
                 (sys:poke-u64 (+ r 0) 7)     (sys:poke-u64 (+ r 8) (+ r 128))    ; form -> pgbox
                 (sys:poke-u64 (+ r 128) 4)   (sys:poke-u64 (+ r 136) (+ r 2432)) ; pgbox.car "progn"
                 (sys:poke-u64 (+ r 160) 7)   (sys:poke-u64 (+ r 168) (+ r 256))  ; pgbox.cdr -> pg2
                 (sys:poke-u64 (+ r 256) 7)   (sys:poke-u64 (+ r 264) (+ r 512))  ; pg2.car (while...) -> whbox
                 (sys:poke-u64 (+ r 288) 7)   (sys:poke-u64 (+ r 296) (+ r 384))  ; pg2.cdr -> pg3
                 (sys:poke-u64 (+ r 384) 4)   (sys:poke-u64 (+ r 392) (+ r 2560)) ; pg3.car x
                 (sys:poke-u64 (+ r 416) 0)                                       ; pg3.cdr NIL
                 (sys:poke-u64 (+ r 512) 4)   (sys:poke-u64 (+ r 520) (+ r 2496)) ; whbox.car "while"
                 (sys:poke-u64 (+ r 544) 7)   (sys:poke-u64 (+ r 552) (+ r 640))  ; whbox.cdr -> wh2
                 (sys:poke-u64 (+ r 640) 7)   (sys:poke-u64 (+ r 648) (+ r 896))  ; wh2.car (< x 42) -> ltbox
                 (sys:poke-u64 (+ r 672) 7)   (sys:poke-u64 (+ r 680) (+ r 768))  ; wh2.cdr -> wh3
                 (sys:poke-u64 (+ r 768) 7)   (sys:poke-u64 (+ r 776) (+ r 1024)) ; wh3.car (setq...) -> sqbox
                 (sys:poke-u64 (+ r 800) 0)                                       ; wh3.cdr NIL
                 (sys:poke-u64 (+ r 896) 4)   (sys:poke-u64 (+ r 904) (+ r 2624)) ; ltbox.car "<"
                 (sys:poke-u64 (+ r 928) 7)   (sys:poke-u64 (+ r 936) (+ r 1152)) ; ltbox.cdr -> lt2
                 (sys:poke-u64 (+ r 1152) 4)  (sys:poke-u64 (+ r 1160) (+ r 2560)); lt2.car x
                 (sys:poke-u64 (+ r 1184) 7)  (sys:poke-u64 (+ r 1192) (+ r 1280)); lt2.cdr -> lt3
                 (sys:poke-u64 (+ r 1280) 2)  (sys:poke-u64 (+ r 1288) 42)        ; lt3.car INT 42
                 (sys:poke-u64 (+ r 1312) 0)                                      ; lt3.cdr NIL
                 (sys:poke-u64 (+ r 1024) 4)  (sys:poke-u64 (+ r 1032) (+ r 2688)); sqbox.car "setq"
                 (sys:poke-u64 (+ r 1056) 7)  (sys:poke-u64 (+ r 1064) (+ r 1408)); sqbox.cdr -> sq2
                 (sys:poke-u64 (+ r 1408) 4)  (sys:poke-u64 (+ r 1416) (+ r 2560)); sq2.car x
                 (sys:poke-u64 (+ r 1440) 7)  (sys:poke-u64 (+ r 1448) (+ r 1536)); sq2.cdr -> sq3
                 (sys:poke-u64 (+ r 1536) 7)  (sys:poke-u64 (+ r 1544) (+ r 1664)); sq3.car (+ x 1) -> plbox
                 (sys:poke-u64 (+ r 1568) 0)                                      ; sq3.cdr NIL
                 (sys:poke-u64 (+ r 1664) 4)  (sys:poke-u64 (+ r 1672) (+ r 2752)); plbox.car "+"
                 (sys:poke-u64 (+ r 1696) 7)  (sys:poke-u64 (+ r 1704) (+ r 1792)); plbox.cdr -> pl2
                 (sys:poke-u64 (+ r 1792) 4)  (sys:poke-u64 (+ r 1800) (+ r 2560)); pl2.car x
                 (sys:poke-u64 (+ r 1824) 7)  (sys:poke-u64 (+ r 1832) (+ r 1920)); pl2.cdr -> pl3
                 (sys:poke-u64 (+ r 1920) 2)  (sys:poke-u64 (+ r 1928) 1)         ; pl3.car INT 1
                 (sys:poke-u64 (+ r 1952) 0)                                      ; pl3.cdr NIL
                 ;; env ((x . 0)): envslot @2048 -> ebox @2176 -> pairbox @2304
                 (sys:poke-u64 (+ r 2048) 7)  (sys:poke-u64 (+ r 2056) (+ r 2176)); envslot CONS -> ebox
                 (sys:poke-u64 (+ r 2176) 7)  (sys:poke-u64 (+ r 2184) (+ r 2304)); ebox.car -> pairbox
                 (sys:poke-u64 (+ r 2208) 0)                                      ; ebox.cdr NIL
                 (sys:poke-u64 (+ r 2304) 4)  (sys:poke-u64 (+ r 2312) (+ r 2560)); pairbox.car x
                 (sys:poke-u64 (+ r 2336) 2)  (sys:poke-u64 (+ r 2344) 0)         ; pairbox.cdr INT 0 (mutable)
                 ;; strings
                 (sys:poke-u64 (+ r 2432) 5)  (sys:poke-u64 (+ r 2440) (+ r 2464)) (sys:poke-u64 (+ r 2448) 5) ; "progn"
                 (sys:poke-u64 (+ r 2464) 112)
                 (sys:poke-u64 (+ r 2496) 5)  (sys:poke-u64 (+ r 2504) (+ r 2528)) (sys:poke-u64 (+ r 2512) 5) ; "while"
                 (sys:poke-u64 (+ r 2528) 119)
                 (sys:poke-u64 (+ r 2560) 1)  (sys:poke-u64 (+ r 2568) (+ r 2592)) (sys:poke-u64 (+ r 2576) 1) ; "x"
                 (sys:poke-u64 (+ r 2592) 120)
                 (sys:poke-u64 (+ r 2624) 1)  (sys:poke-u64 (+ r 2632) (+ r 2656)) (sys:poke-u64 (+ r 2640) 1) ; "<"
                 (sys:poke-u64 (+ r 2656) 60)
                 (sys:poke-u64 (+ r 2688) 4)  (sys:poke-u64 (+ r 2696) (+ r 2720)) (sys:poke-u64 (+ r 2704) 4) ; "setq"
                 (sys:poke-u64 (+ r 2720) 115)
                 (sys:poke-u64 (+ r 2752) 1)  (sys:poke-u64 (+ r 2760) (+ r 2784)) (sys:poke-u64 (+ r 2768) 1) ; "+"
                 (sys:poke-u64 (+ r 2784) 43)
                 (sys:poke-u64 (+ r 2848) (+ r 2880))                             ; bump cell (unused this test) -> arena
                 (nl_eval (+ r 0) (+ r 2048) (+ r 2848))))
             (sys:defun _start () void
               (:abi nelisp-internal :syscall may :alloc none)
               (sys:exit (main))))
           path)
...
(ert-deftest nelisp-sys-eval-kernel-cons-cond-runs ()
  "Doc 133 eval-kernel step 9: add the `cond' special form.
Builds on `nelisp-sys-eval-kernel-cons-while-runs'.  Adds nl_eval_cond,
which walks a clause list: for each clause (test . body), if (nl_eval
test) is non-nil it evaluates the clause body and returns; else it
recurses on the next clause; an exhausted clause list returns 0.  A cond
dispatch (op `c' (99) / len 4) is added in the SYMBOL-operator path
before arithmetic: (nl_eval_cond (+ box 32) env acell) over the cdr
clause list.  The form `(cond ((< 5 3) 0) (1 42))' is pre-built in
memory: clause 1's test (< 5 3) is 0 (skipped), clause 2's test 1 is
truthy -> its body 42 -> exit 42.  Native-verified; no Rust runtime."
  (unless (and (eq system-type 'gnu/linux)
               (string-prefix-p "x86_64" system-configuration))
    (ert-skip "requires x86_64 Linux"))
  (require 'nelisp-sys-adapter-nelisp)
  (unless (nelisp-sys-adapter-available-p)
    (ert-skip "NeLisp toolchain not available"))
  (let ((path (make-temp-file "nelisp-sys-eval-cons-cond")))
    (unwind-protect
        (progn
          (delete-file path)
          (nelisp-sys-compile-executable
           '((sys:defun nl_symname_byte ((slot usize)) i64 (:alloc none)
             ...
             (sys:defun main () i64 (:syscall may :alloc none)
               (let ((r usize (sys:syscall 9 0 4096 3 34 -1 0)))
                 (sys:poke-u64 (+ r 0) 7)     (sys:poke-u64 (+ r 8) (+ r 128))    ; form -> cbox
                 (sys:poke-u64 (+ r 128) 4)   (sys:poke-u64 (+ r 136) (+ r 1408)) ; cbox.car "cond"
                 (sys:poke-u64 (+ r 160) 7)   (sys:poke-u64 (+ r 168) (+ r 256))  ; cbox.cdr -> clbox0
                 (sys:poke-u64 (+ r 256) 7)   (sys:poke-u64 (+ r 264) (+ r 512))  ; clbox0.car clause1 -> clause1box
                 (sys:poke-u64 (+ r 288) 7)   (sys:poke-u64 (+ r 296) (+ r 384))  ; clbox0.cdr -> clbox1
                 (sys:poke-u64 (+ r 384) 7)   (sys:poke-u64 (+ r 392) (+ r 640))  ; clbox1.car clause2 -> clause2box
                 (sys:poke-u64 (+ r 416) 0)                                       ; clbox1.cdr NIL
                 (sys:poke-u64 (+ r 512) 7)   (sys:poke-u64 (+ r 520) (+ r 768))  ; clause1box.car (< 5 3) -> ltbox
                 (sys:poke-u64 (+ r 544) 7)   (sys:poke-u64 (+ r 552) (+ r 896))  ; clause1box.cdr -> cl1b2
                 (sys:poke-u64 (+ r 896) 2)   (sys:poke-u64 (+ r 904) 0)          ; cl1b2.car INT 0
                 (sys:poke-u64 (+ r 928) 0)                                       ; cl1b2.cdr NIL
                 (sys:poke-u64 (+ r 640) 2)   (sys:poke-u64 (+ r 648) 1)          ; clause2box.car INT 1 (test)
                 (sys:poke-u64 (+ r 672) 7)   (sys:poke-u64 (+ r 680) (+ r 1024)) ; clause2box.cdr -> cl2b2
                 (sys:poke-u64 (+ r 1024) 2)  (sys:poke-u64 (+ r 1032) 42)        ; cl2b2.car INT 42
                 (sys:poke-u64 (+ r 1056) 0)                                      ; cl2b2.cdr NIL
                 (sys:poke-u64 (+ r 768) 4)   (sys:poke-u64 (+ r 776) (+ r 1472)) ; ltbox.car "<"
                 (sys:poke-u64 (+ r 800) 7)   (sys:poke-u64 (+ r 808) (+ r 1152)) ; ltbox.cdr -> lt2
                 (sys:poke-u64 (+ r 1152) 2)  (sys:poke-u64 (+ r 1160) 5)         ; lt2.car INT 5
                 (sys:poke-u64 (+ r 1184) 7)  (sys:poke-u64 (+ r 1192) (+ r 1280)); lt2.cdr -> lt3
                 (sys:poke-u64 (+ r 1280) 2)  (sys:poke-u64 (+ r 1288) 3)         ; lt3.car INT 3
                 (sys:poke-u64 (+ r 1312) 0)                                      ; lt3.cdr NIL
                 (sys:poke-u64 (+ r 1408) 4)  (sys:poke-u64 (+ r 1416) (+ r 1440)) (sys:poke-u64 (+ r 1424) 4) ; Str "cond"
                 (sys:poke-u64 (+ r 1440) 99)
                 (sys:poke-u64 (+ r 1472) 1)  (sys:poke-u64 (+ r 1480) (+ r 1504)) (sys:poke-u64 (+ r 1488) 1) ; Str "<"
                 (sys:poke-u64 (+ r 1504) 60)
                 (sys:poke-u64 (+ r 1536) 0)                                      ; env NIL
                 (sys:poke-u64 (+ r 1568) (+ r 1600))                            ; bump cell (unused) -> arena
                 (nl_eval (+ r 0) (+ r 1536) (+ r 1568))))
             (sys:defun _start () void
               (:abi nelisp-internal :syscall may :alloc none)
               (sys:exit (main))))
           path)
