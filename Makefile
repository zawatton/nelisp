...
# the development host's own Emacs; `packages/nl-ns/baseline/emacs-30.2.el'
# is the namespace tooling's own pin, a curated set verified on 30.2), and CI runs an
...
STANDALONE_VERSION ?= $(shell tr -d " \t\n\r" < $(CURDIR)/VERSION 2>/dev/null || echo v1.4.0)
standalone-tarball:
