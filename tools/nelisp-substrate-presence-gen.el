...
;; Usage:
;;
;;   emacs -Q --batch -L packages/nl-prelude/src -L packages/nl-ns/src -l tools/nelisp-substrate-presence-gen.el \
...
(defun nlsp--render (names)
  ...
  (with-temp-buffer
    ...
    (insert ";;   NELISP_SUBSTRATE_PRESENCE_GEN_WRITE=1 emacs -Q --batch -L packages/nl-prelude/src -L packages/nl-ns/src \\\n")
    ...
    (insert ";;   emacs -Q --batch -L packages/nl-prelude/src -L packages/nl-ns/src -l tools/nelisp-substrate-presence-gen.el \\\n")
