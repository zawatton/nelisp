...
;; `lisp/nelisp-sexp-layout.el', and cross-checked against the AOT
;; `--emit-vector-slot-ptr-core' implementation in
;; `nelisp-aot-compiler.el' which adds `[NlVector* + 8]' to `idx*32'.
;;
...
;;
;; Arithmetic: `(shl n 5)' computes n*32 in AOT (= `shl rax, 5'
