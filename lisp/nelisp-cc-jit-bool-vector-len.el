...
;;     offset 0:  tag byte (= 10, `nelisp-sexp--tag-bool-vector')
...
Linker: `bridge.rs::_ELISP_ARCHIVE_ANCHOR' includes this symbol so
`dlsym(RTLD_DEFAULT, \"nl_jit_bool_vector_len\")' resolves at runtime.")
