#+TITLE: NeLisp — Self-Hosted Emacs Lisp VM (v0.6.0)
#+AUTHOR: zawatton
#+DATE: 2026-06-26
...
v0.6.0 is the current stable tag.  It collects the large post-v0.5.1
develop line into one release and makes SemVer tags the user-facing
versioning scheme.
...
NeLisp v0.6.0 centers the runtime in Elisp, keeps the standalone path
