...
//! `nl_jit_record_len' trampoline.  ABI: `(*const Sexp, *mut Sexp)
//! -> i64' returning 0 on OK (`*out = Sexp::Int(slots.len)') / 1 on
//! ERR (non-Record).
//!
//! See `elisp_cc_jit_record_type_probe.rs' for the pipeline rationale.
