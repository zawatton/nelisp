...
//!   eval EXPR       evaluate EXPR via the Doc 44 §3.2 minimal
//!                   evaluator + print the result
//!   -l FILE         load + eval FILE (every form, last value
//!                   printed)
//!   -               read from stdin and eval as a sequence of
//!                   forms
//!
...
Elisp-pivot rollback.  Use the Elisp driver `lisp/doc47-mint.el' via
`emacs --batch' instead.";
