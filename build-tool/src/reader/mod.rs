mod error; pub use error::{ReadError, SourcePos}; pub use crate::eval::sexp::{fmt_sexp, Sexp}; use crate::elisp_cc_spike;
const PARSER_POOL_SIZE: usize = 3 + 4 * 1024; const SCRATCH_CAP: i64 = 64; const START_POS: SourcePos = SourcePos { line: 1, col: 1 };
