...
#[cfg(test)] mod tests { use super::*;
    fn s(n: &str) -> Sexp { Sexp::Symbol(n.into()) } fn i(n: i64) -> Sexp { Sexp::Int(n) } fn err(e: &EvalError, tag: &str) -> bool { matches!(e, EvalError::Generic(t, _) if t == tag) }
