...
mod tests {
    ...
    #[test] fn primitive_is_bound_reflects_set_value() {
    ...
    #[test] fn primitive_set_function_round_trip() {
    ...
    #[test] fn primitive_constant_flag_round_trip() {
    ...
    #[test] fn primitive_clear_value_drops_binding() {
