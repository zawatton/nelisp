...
mod tests {
    ...
    #[test] fn primitive_is_bound_reflects_set_value() { ok!("(nelisp--env-globals-is-bound 'doc-86-3a-bar)" => Sexp::Nil); ok!("(nelisp--env-globals-set-value 'doc-86-3a-bar 7) (nelisp--env-globals-is-bound 'doc-86-3a-bar)" => all => Sexp::T); }
    #[test] fn primitive_set_function_round_trip() { ok!("(nelisp--env-globals-set-function 'doc-86-3a-fn (nelisp--env-globals-get-function 'eq)) (nelisp--env-globals-is-fbound 'doc-86-3a-fn)" => all => Sexp::T); ok!("(nelisp--env-globals-set-function 'doc-86-3a-fn2 (nelisp--env-globals-get-function 'eq)) (nelisp--env-globals-clear-function 'doc-86-3a-fn2) (nelisp--env-globals-is-fbound 'doc-86-3a-fn2)" => all => Sexp::Nil); }
    #[test] fn primitive_constant_flag_round_trip() { ok!("(nelisp--env-globals-is-constant 'doc-86-3a-cflag)" => Sexp::Nil); ok!("(nelisp--env-globals-set-constant 'doc-86-3a-cflag t) (nelisp--env-globals-is-constant 'doc-86-3a-cflag)" => all => Sexp::T); }
    #[test] fn primitive_capture_lexical_at_top_level_is_nil() { ok!("(nelisp--env-globals-op 'capture-lexical)" => Sexp::Nil); }
    #[test] fn primitive_clear_value_drops_binding() { ok!("(nelisp--env-globals-set-value 'doc-86-3a-baz 1) (nelisp--env-globals-clear-value 'doc-86-3a-baz) (nelisp--env-globals-is-bound 'doc-86-3a-baz)" => all => Sexp::Nil); }
}
