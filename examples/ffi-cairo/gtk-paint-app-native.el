...
(seq
 ...
 ;; Undo: scan back to the last stroke-start (flag=1) and truncate count there.
 ...
 ;; helper: make a button with LABEL, connect it to HANDLER, append to BAR.
      ...
      (seq
       ...
       (let ((window (extern-call gtk_window_new)))
         (seq
          ...
          (extern-call gtk_window_set_default_size window 360 260)
